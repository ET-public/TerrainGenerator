...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.sprintSpeed = EditorGUILayout.Slider(new GUIContent("Sprint Speed", "Determines how fast the player will move while sprinting."), fpc.sprintSpeed, fpc.walkSpeed, 10000f);
